...
public class ChestOro : MonoBehaviour
{
    ...
    private void Start()
    {
        cofre = PlayerPrefs.GetInt("CofreOro");
        if(cofre == 1)
        {
        ...
        lastChestOpen = ulong.Parse(PlayerPrefs.GetString("LastChestOpen2"));
    ...
    {
        lastChestOpen = (ulong)DateTime.Now.Ticks;
        PlayerPrefs.SetString("LastChestOpen2", lastChestOpen.ToString());
        chestButton.interactable = false;
    }
